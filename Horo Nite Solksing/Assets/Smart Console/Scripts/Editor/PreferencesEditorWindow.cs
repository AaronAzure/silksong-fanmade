...
namespace ED.SC.Editor
{
	public class PreferencesEditorWindow : EditorWindow
	{
		...
		[SerializeField] private SmartConsolePreferences m_SmartConsolePreferences;

		private const string k_Version = "2.0";
		...
		private void OnEnable()
		{
			...
			if (m_SmartConsolePreferences == null)
			{
				m_SmartConsolePreferences = AssetDatabase.LoadAssetAtPath<SmartConsolePreferences>("Assets/Smart Console/Themes/Smart Console Preferences.asset");
		...
		private void OnGUI()
		{
			EditorGUILayout.LabelField($"Smart Console Version {k_Version}", EditorStyles.miniLabel);
			...
			EditorGUILayout.LabelField("Text Font Sizes", EditorStyles.boldLabel);
			...
			{
				m_SmartConsolePreferences.Reset();
		...
		{
			m_GlobalFont = m_SmartConsolePreferences.GlobalFont;

			m_Opacity = m_SmartConsolePreferences.Opacity;

			m_LogTextFontSize = m_SmartConsolePreferences.LogTextFontSize;
			m_AutocompleteTextFontSize = m_SmartConsolePreferences.AutocompleteTextFontSize;

			m_LogTextColor = m_SmartConsolePreferences.LogTextColor;
			m_CommandTextColor = m_SmartConsolePreferences.CommandTextColor;
			m_WarningTextColor = m_SmartConsolePreferences.WarningTextColor;
			m_ErrorTextColor = m_SmartConsolePreferences.ErrorTextColor;
			m_AutocompleteTextColor = m_SmartConsolePreferences.AutocompleteTextColor;
			m_AutocompleteParameterTextColor = m_SmartConsolePreferences.AutocompleteParameterTextColor;
			m_HighlightTextColor = m_SmartConsolePreferences.HighlightTextColor;

			m_BackgroundMainColor = m_SmartConsolePreferences.BackgroundMainColor;
			m_BackgroundEvenColor = m_SmartConsolePreferences.BackgroundEvenColor;
			m_BackgroundSelectionColor = m_SmartConsolePreferences.BackgroundSelectionColor;
			m_BackgroundAutocompleteColor = m_SmartConsolePreferences.BackgroundAutocompleteColor;
		}

		private void SavePreferences()
		{
			m_SmartConsolePreferences.GlobalFont = m_GlobalFont;

			m_SmartConsolePreferences.Opacity = m_Opacity;

			m_SmartConsolePreferences.LogTextFontSize = m_LogTextFontSize;
			m_SmartConsolePreferences.AutocompleteTextFontSize = m_AutocompleteTextFontSize;

			m_SmartConsolePreferences.LogTextColor = m_LogTextColor;
			m_SmartConsolePreferences.CommandTextColor = m_CommandTextColor;
			m_SmartConsolePreferences.WarningTextColor = m_WarningTextColor;
			m_SmartConsolePreferences.ErrorTextColor = m_ErrorTextColor;
			m_SmartConsolePreferences.AutocompleteTextColor = m_AutocompleteTextColor;
			m_SmartConsolePreferences.AutocompleteParameterTextColor = m_AutocompleteParameterTextColor;
			m_SmartConsolePreferences.HighlightTextColor = m_HighlightTextColor;

			m_SmartConsolePreferences.BackgroundMainColor = m_BackgroundMainColor;
			m_SmartConsolePreferences.BackgroundEvenColor = m_BackgroundEvenColor;
			m_SmartConsolePreferences.BackgroundSelectionColor = m_BackgroundSelectionColor;
			m_SmartConsolePreferences.BackgroundAutocompleteColor = m_BackgroundAutocompleteColor;
		}
